...
export type DecisionKind = "auto-approved" | "policy-denied" | "card-shown" | "user-approved" | "user-denied";
...
export type DecisionSource = AutoVerdictSource | "policy-never" | "policy-ask" | "policy-always" | "question" | "auto-fallback" | "user";
